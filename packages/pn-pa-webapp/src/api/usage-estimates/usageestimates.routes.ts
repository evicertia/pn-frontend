...
const API_UPDATE_ESTIMATES_PATH = `${API_VERSION}/:${API_ESTIMATE_PA_ID_PARAMETER}/${API_ESTIMATE_SEGMENT}/:${API_ESTIMATE_REFERENCE_MONTH_PARAMETER}`;
...
const API_ESTIMATE_FILES_PATH = `${API_VERSION}/${API_ESTIMATE_SEGMENT}/:${API_ESTIMATE_PA_ID_PARAMETER}/${API_ESTIMATE_FILES_SEGMENT}/:${API_ESTIMATE_REFERENCE_MONTH_PARAMETER}`;
